...
| R package | Package 'secr' | resource3_note | Package info: <https://CRAN.R-project.org/package=secr><br>Guide: <https://cran.r-project.org/web/packages/secr/vignettes/secr-overview.pdf> | {{ rbib_efford_2024a }};<br><br>{{ rbib_efford_2024b }} |
