...
| resource3_type | resource3_name | resource3_note | <> | {{ rbib_resource3_ref_id }} |
...
| App/Program | DENSITY | Software for analysing capture-recapture data from passive detector arrays. | <https://doi.org/10.32800/abc.2004.27.021> | {{ rbib_efford_et_al_2004 }} |
...
| R package | openCR: Open population capture-recapture models | | <https://CRAN.R-project.org/package=openCR> | {{ rbib_efford_2023 }} |
